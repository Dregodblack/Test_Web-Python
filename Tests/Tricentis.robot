...
# Comando para rodar suite de Teste: robot -d ./relatorios/results Testes/Tricentis.robot
##################################################################################################################################
...
# robot -v browser:chrome -t "CT01: Preencher os formulários das paginas e clicando no Botão Next" -d ./relatorios/results Testes/Tricentis.robot"
